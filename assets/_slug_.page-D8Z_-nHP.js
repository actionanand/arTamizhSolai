import{ɵ as q,C as Y,N as Lt,R as gt,g as h,l as f,a as l,b as d,c,h as V,n as g,k as s,m as F,o as xt,p as T,q as b,L as St,w as G,z as w,B as y,v as et,t as C,e as P,E as W,M as jt,O as vt,F as U,P as zt,Q as Nt,S as Dt,T as At,U as Et,V as ot,W as $t,s as Pt,X as Bt,Y as Ht,Z as Rt,_ as wt,$ as yt,a0 as mt,G as R,H as L,K as _t,J as Gt,D as Q,a1 as Zt,i as Ut,f as J,a2 as qt,a3 as Yt,a4 as Vt,a5 as Ft,x as I,y as O,a6 as Wt,a7 as ht,a8 as ft,j as Qt,d as Jt,a9 as Xt}from"./index-DkhoaWva.js";import{p as Kt}from"./pagination-config-BIRU8DJ8.js";import{F as tn}from"./format-date.pipe-DWGCaC9x.js";function nn(o){const n=[],t=/<h([1-4])[^>]*?(?:id=\"([^\"]*)\")?[^>]*>([\s\S]*?)<\/h\1>/gi;let e;for(;(e=t.exec(o))!==null;){const i=parseInt(e[1],10),r=e[2]||en(bt(e[3])),a=on(bt(e[3]).trim());n.push({level:i,text:a,id:r})}return n}function bt(o){return o.replace(/<[^>]*>/g,"")}function en(o){return o.toLowerCase().replace(/[^a-z0-9\s-]/g,"").trim().replace(/\s+/g,"-").replace(/-+/g,"-")}function on(o){return o.replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&#39;/g,"'")}const an=()=>[],rn=(o,n)=>n.id;function sn(o,n){if(o&1){const t=xt();l(0,"li",4)(1,"a",5),T("click",function(){const i=w(t).$implicit,r=g(2);return y(r.scrollToElement(i.id))}),d(2),c()()}if(o&2){const t=n.$implicit;b("ngClass","toc__item--level-"+t.level),s(),b("routerLink",St(4,an))("fragment",t.id),s(),G(" ",t.text," ")}}function cn(o,n){if(o&1&&(l(0,"aside",0)(1,"nav",1)(2,"h3",2),d(3,"Table of Contents"),c(),l(4,"ul",3),V(5,sn,3,5,"li",4,rn),c()()()),o&2){const t=g();s(5),F(t.headings)}}const S=class S{constructor(){this.headings=[]}scrollToElement(n){setTimeout(()=>{const t=document.getElementById(n);t&&t.scrollIntoView({behavior:"smooth",block:"start"})},0)}};S.ɵfac=function(t){return new(t||S)},S.ɵcmp=q({type:S,selectors:[["app-table-of-contents"]],inputs:{headings:"headings"},decls:1,vars:1,consts:[[1,"toc"],[1,"toc__nav"],[1,"toc__title"],[1,"toc__list"],[1,"toc__item",3,"ngClass"],[1,"toc__link",3,"click","routerLink","fragment"]],template:function(t,e){t&1&&h(0,cn,7,0,"aside",0),t&2&&f(e.headings.length>0?0:-1)},dependencies:[Y,Lt,gt],styles:[`.toc[_ngcontent-%COMP%] {
      position: sticky;
      top: 100px;
    ...
    }`]});let it=S;const It=o=>["/blog",o];function ln(o,n){if(o&1&&(l(0,"a",1)(1,"span",4),d(2,"← Previous"),c(),l(3,"span",5),d(4),c()()),o&2){const t=g();b("routerLink",et(2,It,t.previousPost.attributes.slug)),s(4),C(t.previousPost.attributes.title)}}function dn(o,n){o&1&&P(0,"div",2)}function pn(o,n){if(o&1&&(l(0,"a",3)(1,"span",4),d(2,"Next →"),c(),l(3,"span",5),d(4),c()()),o&2){const t=g();b("routerLink",et(2,It,t.nextPost.attributes.slug)),s(4),C(t.nextPost.attributes.title)}}function gn(o,n){o&1&&P(0,"div",2)}const j=class j{constructor(){this.previousPost=null,this.nextPost=null}};j.ɵfac=function(t){return new(t||j)},j.ɵcmp=q({type:j,selectors:[["app-post-navigation"]],inputs:{previousPost:"previousPost",nextPost:"nextPost"},decls:5,vars:2,consts:[[1,"post-nav"],[1,"post-nav__link","post-nav__link--prev",3,"routerLink"],[1,"post-nav__placeholder"],[1,"post-nav__link","post-nav__link--next",3,"routerLink"],[1,"post-nav__label"],[1,"post-nav__title"]],template:function(t,e){t&1&&(l(0,"nav",0),h(1,ln,5,4,"a",1)(2,dn,1,0,"div",2),h(3,pn,5,4,"a",3)(4,gn,1,0,"div",2),c()),t&2&&(s(),f(e.previousPost?1:2),s(2),f(e.nextPost?3:4))},dependencies:[gt,Y],styles:[`.post-nav[_ngcontent-%COMP%] {
      display: grid;
