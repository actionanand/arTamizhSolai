import{ɵ as F,C as V,N as Nt,R as ft,g as u,l as h,a as l,b as g,c,h as J,n as _,k as s,m as X,o as bt,p as T,q as b,L as Et,w as Y,z as w,B as y,v as at,t as C,e as P,E as q,M as $t,O as kt,F as j,P as St,Q as Bt,S as Ht,T as Rt,U as Gt,V as et,W as Zt,s as Lt,X as Ut,Y as Ft,Z as Vt,_ as Mt,$ as Ct,a0 as Pt,G as L,H as k,K as xt,J as Yt,D as K,f as Q,I as qt,a1 as Wt,i as Qt,a2 as Jt,a3 as Xt,a4 as Kt,a5 as tn,x as I,y as O,a6 as nn,a7 as wt,a8 as yt,a9 as en,j as on,d as an,aa as rn}from"./index-QLICWfDC.js";import{p as sn}from"./pagination-config-BIRU8DJ8.js";import{g as cn}from"./cover-image-helper-DcEpFtqo.js";import{F as ln}from"./format-date.pipe-JR85KQ1D.js";function dn(o){const n=[],t=/<h([1-4])[^>]*?(?:id=\"([^\"]*)\")?[^>]*>([\s\S]*?)<\/h\1>/gi;let e;for(;(e=t.exec(o))!==null;){const i=parseInt(e[1],10),r=e[2]||pn(It(e[3])),a=gn(It(e[3]).trim());n.push({level:i,text:a,id:r})}return n}function It(o){return o.replace(/<[^>]*>/g,"")}function pn(o){return o.toLowerCase().replace(/[^a-z0-9\s-]/g,"").trim().replace(/\s+/g,"-").replace(/-+/g,"-")}function gn(o){return o.replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&#39;/g,"'")}const _n=()=>[],mn=(o,n)=>n.id;function un(o,n){if(o&1){const t=bt();l(0,"li",4)(1,"a",5),T("click",function(){const i=w(t).$implicit,r=_(2);return y(r.scrollToElement(i.id))}),g(2),c()()}if(o&2){const t=n.$implicit;b("ngClass","toc__item--level-"+t.level),s(),b("routerLink",Et(4,_n))("fragment",t.id),s(),Y(" ",t.text," ")}}function hn(o,n){if(o&1&&(l(0,"aside",0)(1,"nav",1)(2,"h3",2),g(3,"Table of Contents"),c(),l(4,"ul",3),J(5,un,3,5,"li",4,mn),c()()()),o&2){const t=_();s(5),X(t.headings)}}const z=class z{constructor(){this.headings=[]}scrollToElement(n){setTimeout(()=>{const t=document.getElementById(n);t&&t.scrollIntoView({behavior:"smooth",block:"start"})},0)}};z.ɵfac=function(t){return new(t||z)},z.ɵcmp=F({type:z,selectors:[["app-table-of-contents"]],inputs:{headings:"headings"},decls:1,vars:1,consts:[[1,"toc"],[1,"toc__nav"],[1,"toc__title"],[1,"toc__list"],[1,"toc__item",3,"ngClass"],[1,"toc__link",3,"click","routerLink","fragment"]],template:function(t,e){t&1&&u(0,hn,7,0,"aside",0),t&2&&h(e.headings.length>0?0:-1)},dependencies:[V,Nt,ft],styles:[`.toc[_ngcontent-%COMP%] {
      position: sticky;
      top: 100px;
    ...
    }`]});let st=z;const jt=o=>["/blog",o];function fn(o,n){if(o&1&&(l(0,"a",1)(1,"span",4),g(2,"← Previous"),c(),l(3,"span",5),g(4),c()()),o&2){const t=_();b("routerLink",at(2,jt,t.previousPost.attributes.slug)),s(4),C(t.previousPost.attributes.title)}}function bn(o,n){o&1&&P(0,"div",2)}function Mn(o,n){if(o&1&&(l(0,"a",3)(1,"span",4),g(2,"Next →"),c(),l(3,"span",5),g(4),c()()),o&2){const t=_();b("routerLink",at(2,jt,t.nextPost.attributes.slug)),s(4),C(t.nextPost.attributes.title)}}function Cn(o,n){o&1&&P(0,"div",2)}const A=class A{constructor(){this.previousPost=null,this.nextPost=null}};A.ɵfac=function(t){return new(t||A)},A.ɵcmp=F({type:A,selectors:[["app-post-navigation"]],inputs:{previousPost:"previousPost",nextPost:"nextPost"},decls:5,vars:2,consts:[[1,"post-nav"],[1,"post-nav__link","post-nav__link--prev",3,"routerLink"],[1,"post-nav__placeholder"],[1,"post-nav__link","post-nav__link--next",3,"routerLink"],[1,"post-nav__label"],[1,"post-nav__title"]],template:function(t,e){t&1&&(l(0,"nav",0),u(1,fn,5,4,"a",1)(2,bn,1,0,"div",2),u(3,Mn,5,4,"a",3)(4,Cn,1,0,"div",2),c()),t&2&&(s(),h(e.previousPost?1:2),s(2),h(e.nextPost?3:4))},dependencies:[ft,V],styles:[`.post-nav[_ngcontent-%COMP%] {
      display: grid;
...
</div>`})}const D=class D{transform(n){return n&&typeof n=="string"?vn(n):""}};D.ɵfac=function(t){return new(t||D)},D.ɵpipe=q({name:"admonitionTransform",type:D,pure:!0});let lt=D;const N=class N{transform(n){if(!n)return"";const t=new Map;let e=n;const i=/:::footnotes\s*\n([\s\S]*?)\n:::/g,r=i.exec(n);if(r){const m=r[1],f=/^\[\^([^\]]+)\]:\s*(.+)$/gm;let x;for(;(x=f.exec(m))!==null;){const v=x[1].trim(),W=x[2].trim();v&&t.set(v,W)}e=n.replace(i,"").trim()}else{const f=/\n\n(\[\^[^\]]+\]:.+\n?)+$/.exec(n);if(f){const x=f[0],v=/^\[\^([^\]]+)\]:\s*(.+)$/gm;let W;for(;(W=v.exec(x))!==null;){const vt=W[1].trim(),Dt=W[2].trim();vt&&t.set(vt,Dt)}e=n.substring(0,n.length-x.length).trim()}}const a=new Map,d=new Map;let p=0;const M=/\[\^([^\]]+)\]/g;if(e.replace(M,(m,f)=>{const x=String(f).trim();return a.has(x)||(p+=1,a.set(x,p),d.set(p,x)),""}),e=e.replace(M,(m,f)=>{const x=String(f).trim(),v=a.get(x);return v?`<sup><a data-fn="fn-${v}" id="fnref-${v}" class="footnote-ref" role="button" tabindex="0">[${v}]</a></sup>`:m}),a.size>0){let m=`
...
`,m+=`</div>
`,m+=`<ol>
`;for(let f=1;f<=a.size;f++){const x=d.get(f);let v=t.get(x)||"";v=this.parseMarkdownLinks(v),m+=`<li id="fn-${f}"><p>${v} <a data-fn="fnref-${f}" class="footnote-backref" role="button" tabindex="0" title="Back to reference">↩</a></p></li>
`}m+=`</ol>
</section>
...
</div>`})}processGenericCards(n){const t=/::card\[([^\]]+)\]\{([^}]+)\}/g;return n.replace(t,(e,i,r)=>{const a=i.split("|").map(x=>x.trim()),d=a[0],p=a[1],M=this.sanitizeType(d),m=p?this.sanitizeColor(p):"#0066cc",f=p?this.getColorClass(p.toLowerCase()):"default";switch(M){case"info":return`<div class="card card--info ${f}">
  <div class="card__header">
...
</div>`;default:return`<div class="card card--generic ${f}" style="border-top-color: ${m}">
  <div class="card__content">
    <p>${r}</p>
  </div>
...
@media (prefers-color-scheme: dark) {
  ...
  .gpay-upi-label[_ngcontent-%COMP%] {
...
}`],changeDetection:0});let ut=G;function An(o,n){if(o&1){const t=bt();L(0,"button",1),qt("click",function(){w(t);const i=_();return y(i.scrollToTop())}),g(1," ↑ "),k()}}const Z=class Z{constructor(n){this.platformId=n,this.isVisible=j(!1),this.scrollThreshold=300,this.onScroll=()=>{this.checkScrollPosition()},this.isBrowser=Ct(this.platformId)}ngAfterViewInit(){this.isBrowser&&(window.addEventListener("scroll",this.onScroll,{passive:!0}),this.checkScrollPosition())}ngOnDestroy(){this.isBrowser&&window.removeEventListener("scroll",this.onScroll)}checkScrollPosition(){if(this.isBrowser){const n=window.pageYOffset||document.documentElement.scrollTop;this.isVisible.set(n>this.scrollThreshold)}}scrollToTop(){this.isBrowser&&window.scrollTo({top:0,behavior:"smooth"})}};Z.ɵfac=function(t){return new(t||Z)(Q(Mt))},Z.ɵcmp=F({type:Z,selectors:[["app-scroll-to-top"]],decls:1,vars:1,consts:[["aria-label","Scroll to top","title","Scroll to top",1,"scroll-to-top"],["aria-label","Scroll to top","title","Scroll to top",1,"scroll-to-top",3,"click"]],template:function(t,e){t&1&&u(0,An,2,0,"button",0),t&2&&h(e.isVisible()?0:-1)},dependencies:[V],styles:[`.scroll-to-top[_ngcontent-%COMP%] {
      position: fixed;
      bottom: 2rem;
      right: 2rem;
      width: 3rem;
    ...
    }`]});let ht=Z;const Dn=["contentRef"],zt=o=>["/blog",o],At=(o,n)=>n.attributes.slug;function Nn(o,n){o&1&&P(0,"app-scroll-to-top")}function En(o,n){if(o&1&&(l(0,"p",7),g(1),I(2,"formatDate"),c()),o&2){const t=_(2);s(),C(O(2,1,t.attributes.date))}}function $n(o,n){o&1&&(l(0,"span",9),g(1,"📝 Draft"),c())}function Bn(o,n){o&1&&(l(0,"span",10),g(1,"📌 Pinned"),c())}function Hn(o,n){if(o&1&&(l(0,"span",25),g(1),c()),o&2){const t=n.$implicit;s(),C(t)}}function Rn(o,n){if(o&1&&J(0,Hn,2,1,"span",25,on),o&2){const t=_(2);X(t.attributes.tags)}}function Gn(o,n){if(o&1&&(l(0,"div",26)(1,"strong"),g(2,"Author:"),c(),g(3),c()),o&2){const t=_(3);s(3),Y(" ",t.attributes.author," ")}}function Zn(o,n){if(o&1&&(l(0,"div",26)(1,"strong"),g(2,"Epic:"),c(),g(3),c()),o&2){const t=_(3);s(3),Y(" ",t.attributes.epicName," ")}}function Un(o,n){if(o&1&&(l(0,"div",26)(1,"strong"),g(2,"Verse Number:"),c(),g(3),c()),o&2){const t=_(3);s(3),Y(" ",t.attributes.verseNumber," ")}}function Fn(o,n){if(o&1&&(l(0,"div",26)(1,"strong"),g(2,"Info:"),c(),g(3),c()),o&2){const t=_(3);s(3),Y(" ",t.attributes.articleMetadata," ")}}function Vn(o,n){if(o&1&&(l(0,"div",12),u(1,Gn,4,1,"div",26),u(2,Zn,4,1,"div",26),u(3,Un,4,1,"div",26),u(4,Fn,4,1,"div",26),c()),o&2){const t=_(2);s(),h(t.attributes.author?1:-1),s(),h(t.attributes.epicName?2:-1),s(),h(t.attributes.verseNumber?3:-1),s(),h(t.attributes.articleMetadata?4:-1)}}function Yn(o,n){if(o&1&&P(0,"app-table-of-contents",16),o&2){const t=_(3);b("headings",t.headings)}}function qn(o,n){if(o&1&&(P(0,"analog-markdown",18),I(1,"processFootnotes"),I(2,"processExplore"),I(3,"admonitionTransform"),I(4,"textFormat"),I(5,"cardFormat"),I(6,"tabs")),o&2){const t=_(2);b("content",O(6,11,O(5,9,O(4,7,O(3,5,O(2,3,O(1,1,typeof t.content=="string"?t.content:"")))))))}}function Wn(o,n){if(o&1&&(l(0,"section",19)(1,"div",27),an(),l(2,"svg",28),P(3,"circle",29)(4,"line",30)(5,"circle",31),c(),rn(),l(6,"h4"),g(7,"Disclaimer"),c()(),l(8,"p"),g(9),c()()),o&2){const t=_(3);s(9),C(t.disclaimerText)}}function Qn(o,n){if(o&1&&P(0,"img",34),o&2){const t=_().$implicit,e=_(4);b("src",e.getCoverImage(t.attributes),K)("alt",t.attributes.title)}}function Jn(o,n){if(o&1&&(l(0,"span",37),g(1),I(2,"formatDate"),c()),o&2){const t=_().$implicit;s(),C(O(2,1,t.attributes.date))}}function Xn(o,n){if(o&1&&(l(0,"li",33),u(1,Qn,1,2,"img",34),l(2,"div",35)(3,"a",36),g(4),c(),u(5,Jn,3,3,"span",37),c()()),o&2){const t=n.$implicit,e=_(4);s(),h(e.getCoverImage(t.attributes)?1:-1),s(2),b("routerLink",at(4,zt,t.attributes.slug)),s(),C(t.attributes.title),s(),h(t.attributes.date?5:-1)}}function Kn(o,n){if(o&1&&(l(0,"div",22)(1,"h3"),g(2,"Related Posts"),c(),l(3,"ul",32),J(4,Xn,6,6,"li",33,At),c()()),o&2){const t=_(3);s(4),X(t.relatedPosts)}}function te(o,n){if(o&1&&P(0,"img",34),o&2){const t=_(2).$implicit,e=_(4);b("src",e.getCoverImage(t.attributes),K)("alt",t.attributes.title)}}function ne(o,n){if(o&1&&(l(0,"span",37),g(1),I(2,"formatDate"),c()),o&2){const t=_(2).$implicit;s(),C(O(2,1,t.attributes.date))}}function ee(o,n){if(o&1&&(l(0,"li",33),u(1,te,1,2,"img",34),l(2,"div",35)(3,"a",36),g(4),c(),u(5,ne,3,3,"span",37),c()()),o&2){const t=_().$implicit,e=_(4);s(),h(e.getCoverImage(t.attributes)?1:-1),s(2),b("routerLink",at(4,zt,t.attributes.slug)),s(),C(t.attributes.title),s(),h(t.attributes.date?5:-1)}}function oe(o,n){if(o&1&&u(0,ee,6,6,"li",33),o&2){const t=n.$implicit,e=_(4);h(t.attributes.slug!==e.currentSlug?0:-1)}}function ie(o,n){if(o&1&&(l(0,"div",23)(1,"h3"),g(2,"Recent Posts"),c(),l(3,"ul",32),J(4,oe,1,1,null,null,At),c()()),o&2){const t=_(3);s(4),X(t.recentPosts)}}function ae(o,n){if(o&1&&(l(0,"article",4)(1,"header",5)(2,"h1",6),g(3),c(),u(4,En,3,3,"p",7),l(5,"div",8),u(6,$n,2,0,"span",9),u(7,Bn,2,0,"span",10),l(8,"span",11),g(9),c(),u(10,Rn,2,0),c(),u(11,Vn,5,4,"div",12),l(12,"p",13),g(13),c()(),P(14,"img",14),l(15,"div",15),u(16,Yn,1,1,"app-table-of-contents",16),l(17,"div",17,0),u(19,qn,7,13,"analog-markdown",18),c()(),u(20,Wn,10,1,"section",19),P(21,"app-donation",20),l(22,"section",21),u(23,Kn,6,0,"div",22)(24,ie,6,0,"div",23),c(),P(25,"app-post-navigation",24),c()),o&2){const t=_(),e=_();en("font-family",t.attributes.font||null),s(3),C(t.attributes.title),s(),h(t.attributes.date?4:-1),s(2),h(t.attributes.isDraft?6:-1),s(),h(t.attributes.isPinned?7:-1),s(2),C(t.attributes.category||"uncategorized"),s(),h(t.attributes.tags&&t.attributes.tags.length>0?10:-1),s(),h(t.attributes.author||t.attributes.epicName||t.attributes.verseNumber||t.attributes.articleMetadata?11:-1),s(2),C(t.attributes.description),s(),b("src",e.getCoverImage(t.attributes),K)("alt",t.attributes.title),s(),Lt("blog-post__container--no-toc",!e.showToc),s(),h(e.showToc&&e.headings.length>0?16:-1),s(3),h(t.content?19:-1),s(),h(e.showDisclaimer?20:-1),s(),b("postAttributes",t.attributes),s(2),h(e.relatedPosts.length>0?23:24),s(2),b("previousPost",e.previousPost)("nextPost",e.nextPost)}}function re(o,n){o&1&&(l(0,"div",3)(1,"div",38),g(2,"🔒"),c(),l(3,"h2"),g(4,"Protected Content"),c(),l(5,"p"),g(6,"This article is password protected. Please unlock to view."),c()())}function se(o,n){if(o&1&&(et(0,Nn,1,0,"app-scroll-to-top",1),u(1,ae,26,21,"article",2)(2,re,7,0,"div",3)),o&2){const t=_();b("ngIf",n.attributes.scrollToTop),s(),h(t.isContentAccessible()?1:2)}}const U=class U{constructor(n,t,e,i){this.cdr=t,this.authService=e,this.router=i,this.post$=Wt("slug"),this.defaultCoverImage="tamil-literature-default.svg",this.getCoverImage=cn,this.isContentAccessible=j(!0),this.allPosts=[],this.headings=[],this.relatedPosts=[],this.recentPosts=[],this.previousPost=null,this.nextPost=null,this.currentSlug="",this.showToc=!0,this.showDisclaimer=!0,this.disclaimerText="The views expressed are personal and for informational purposes only.",this.hasExtractedHeadings=!1,this.isBrowser=Ct(n);const a=Qt().filter(d=>!d.attributes.isDraft);this.allPosts=a.sort((d,p)=>d.attributes.isPinned&&!p.attributes.isPinned?-1:!d.attributes.isPinned&&p.attributes.isPinned?1:new Date(p.attributes.date||"").getTime()-new Date(d.attributes.date||"").getTime())}async ngOnInit(){this.post$.subscribe(async n=>{n&&(this.currentSlug=n.attributes.slug,n.attributes.enableLock?await this.handleAuthentication():this.isContentAccessible.set(!0),this.showToc=n.attributes.toc!==!1,this.showDisclaimer=n.attributes.disclaimerEnabled!==!1,this.disclaimerText=n.attributes.disclaimerText||this.disclaimerText,this.updateNavigation(),this.updateRelatedPosts(n.attributes.relatedPosts),this.recentPosts=this.allPosts.slice(0,sn.articleRecentPostsCount+1),this.headings=[],this.hasExtractedHeadings=!1,this.isBrowser&&setTimeout(()=>{this.setupFootnoteNavigation()},100))})}ngAfterViewInit(){this.updateContentHeadings(),this.isBrowser&&(this.initObserver(),this.setupFootnoteNavigation())}ngAfterViewChecked(){!this.hasExtractedHeadings&&this.contentRef?.nativeElement&&this.isBrowser&&this.contentRef.nativeElement.querySelectorAll("h1, h2, h3, h4").length>0&&this.headings.length===0&&setTimeout(()=>{this.updateContentHeadings(),this.cdr.detectChanges()},0)}ngOnDestroy(){this.mutationObserver&&(this.mutationObserver.disconnect(),this.mutationObserver=void 0)}updateContentHeadings(){if(!this.isBrowser||!this.contentRef?.nativeElement)return;const n=this.contentRef.nativeElement,t=n.querySelectorAll("h1, h2, h3, h4");if(t.length===0)return;t.forEach(r=>{if(!r.id){const a=r.textContent||"";r.id=this.slugify(a)}});const e=n.innerHTML,i=dn(e);i.length>0&&!this.hasExtractedHeadings&&(this.headings=i,this.hasExtractedHeadings=!0)}initObserver(){this.isBrowser&&this.contentRef?.nativeElement&&(this.mutationObserver||(this.mutationObserver=new MutationObserver(()=>{this.updateContentHeadings(),this.setupFootnoteNavigation()}),this.mutationObserver.observe(this.contentRef.nativeElement,{childList:!0,subtree:!0,characterData:!0})))}setupFootnoteNavigation(){if(!this.isBrowser)return;const n=document.querySelector("article.blog-post");if(!n)return;const t=n.cloneNode(!0);n.parentNode&&n.parentNode.replaceChild(t,n);const e=i=>{const a=i.target.getAttribute("data-fn");if(a){i.preventDefault(),i.stopPropagation();const d=a,p=document.getElementById(d);if(p){p.scrollIntoView({behavior:"smooth",block:"start"});const M=document.querySelector("base")?.getAttribute("href")||"/",f=`${M.endsWith("/")?M:`${M}/`}blog/${this.currentSlug}#${d}`;console.log("Updating URL to:",f),window.history.replaceState(null,"",f)}}};t.addEventListener("click",i=>{const r=i.target;(r.classList.contains("footnote-ref")||r.classList.contains("footnote-backref"))&&e(i)})}slugify(n){return n.toLowerCase().replace(/[^a-z0-9\s-]/g,"").trim().replace(/\s+/g,"-").replace(/-+/g,"-")}updateNavigation(){const n=this.allPosts.findIndex(t=>t.attributes.slug===this.currentSlug);n>0?this.previousPost=this.allPosts[n-1]:this.previousPost=null,n<this.allPosts.length-1?this.nextPost=this.allPosts[n+1]:this.nextPost=null}updateRelatedPosts(n){if(this.relatedPosts=[],!n||n.length===0)return;n.slice(0,5).forEach(e=>{const i=this.allPosts.find(r=>r.attributes.slug===e);i&&this.relatedPosts.push(i)})}async handleAuthentication(){if(this.authService.isAuthenticated()){this.isContentAccessible.set(!0);return}this.isContentAccessible.set(!1),setTimeout(async()=>{this.passwordModal&&(await this.passwordModal.show()?(this.isContentAccessible.set(!0),this.cdr.detectChanges()):this.router.navigate(["/blog"]))},100)}};U.ɵfac=function(t){return new(t||U)(Q(Mt),Q(Jt),Q(ot),Q(Xt))},U.ɵcmp=F({type:U,selectors:[["app-blog-post"]],viewQuery:function(t,e){if(t&1&&nn(Dn,5)(it,5),t&2){let i;wt(i=yt())&&(e.contentRef=i.first),wt(i=yt())&&(e.passwordModal=i.first)}},decls:3,vars:3,consts:[["contentRef",""],[4,"ngIf"],[1,"blog-post",3,"font-family"],[1,"locked-content"],[1,"blog-post"],[1,"blog-post__header"],[1,"blog-post__title"],[1,"blog-post__date"],[1,"blog-post__meta"],[1,"post-meta-tag","draft-tag"],[1,"post-meta-tag","pinned-tag"],[1,"post-meta-tag","category-tag"],[1,"blog-post__article-meta"],[1,"blog-post__description"],[1,"blog-post__image",3,"src","alt"],[1,"blog-post__container"],[1,"blog-post__toc",3,"headings"],[1,"blog-post__content"],[3,"content"],[1,"blog-post__disclaimer"],[3,"postAttributes"],[1,"blog-post__related"],[1,"related-posts"],[1,"recent-posts"],[3,"previousPost","nextPost"],[1,"post-meta-tag","tag-tag"],[1,"article-meta-item"],[1,"disclaimer-header"],["viewBox","0 0 24 24","fill","currentColor",1,"disclaimer-icon"],["cx","12","cy","12","r","10","fill","none","stroke","currentColor","stroke-width","2"],["x1","12","y1","8","x2","12","y2","12","stroke","currentColor","stroke-width","2","stroke-linecap","round"],["cx","12","cy","16","r","0.5","fill","currentColor"],[1,"posts-list"],[1,"post-item"],[1,"post-thumbnail",3,"src","alt"],[1,"post-info"],[1,"post-link",3,"routerLink"],[1,"post-date"],[1,"locked-icon"]],template:function(t,e){if(t&1&&(P(0,"app-password-modal"),u(1,se,3,2),I(2,"async")),t&2){let i;s(),h((i=O(2,1,e.post$))?1:-1,i)}},dependencies:[V,St,ft,Kt,st,ct,it,ut,ht,tn,lt,dt,pt,gt,_t,mt,ln],styles:[`.blog-post[_ngcontent-%COMP%] {
      max-width: 900px;
      margin: 0 auto;
    }
